...
class ProjectService:
    ...
    async def list(self, page, page_size, search, sort):
        return await self.repo.list(page, page_size, search, sort)
    ...
    async def create(self, data):
        return await self.repo.add(Project(**data.model_dump()))
